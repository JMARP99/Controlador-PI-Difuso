# 1 "mainControladorTemperatura.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "mainControladorTemperatura.c" 2


# 1 "./lib_pic/config_mcu.h" 1
...
# 77 "./lib_pic/config_mcu.h" 2


void OSCILADOR_Init(void);
# 3 "mainControladorTemperatura.c" 2
...
# 6 "mainControladorTemperatura.c" 2

# 1 "./lib_pic/eusart.h" 1
# 13 "./lib_pic/eusart.h"
...
void putch(char c);
# 7 "mainControladorTemperatura.c" 2
...
# 8 "mainControladorTemperatura.c" 2
# 20 "mainControladorTemperatura.c"
...
void __attribute__((picinterrupt(("high_priority")))) InterruptHighPriority (void)
{
...
void Tomar_muestra_temperatura(void)
{
    ...
    for(i=0;i<20;i++)
    {
        ...
        voutMCP9700A = (((float)ADC_GetConversion(0b00001))*(5.0f/1023.0f));
